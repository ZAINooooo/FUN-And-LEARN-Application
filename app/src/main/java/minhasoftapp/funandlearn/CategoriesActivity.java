...
public class CategoriesActivity extends AppCompatActivity implements AdapterView.OnItemClickListener {
    ...
    private void populateCategoriesList() {
        Highscores.open(this);
                       ...
                       //Fruits category
        Category fruitCategory = new Category("Fruits", R.drawable.fruits, Highscores.getHighscore(MySQLiteHelper.COLUMN_FRUITS),
                getResources().getColor(R.color.primary_dark), R.style.GreenTheme, MySQLiteHelper.COLUMN_FRUITS,
                R.drawable.ic_face_green);


                         //animals category
        Category animalCategory = new Category("Animals", R.drawable.animals,
                Highscores.getHighscore(MySQLiteHelper.COLUMN_ANIMALS),
                getResources().getColor(R.color.blue_primary_dark), R.style.BlueTheme, MySQLiteHelper.COLUMN_ANIMALS,
                R.drawable.ic_face_blue);

                              //Food category
        Category foodCategory = new Category("Food", R.drawable.food, Highscores.getHighscore(MySQLiteHelper.COLUMN_FOOD),
                getResources().getColor(R.color.pink_primary_dark), R.style.PinkTheme, MySQLiteHelper.COLUMN_FOOD,
