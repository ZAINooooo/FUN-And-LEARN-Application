...
public class MySQLiteHelper extends SQLiteOpenHelper
{
    ...
    private static final String DATABASE_CREATE = "create table " + TABLE_HIGHSCORES + "( " + COLUMN_ID + " integer primary key autoincrement," + COLUMN_ANIMALS + " integer,"
                    + COLUMN_FRUITS + " integer," + COLUMN_FOOD + " integer," + COLUMN_COLORS + " integer" + ");";
